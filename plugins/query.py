...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "close":
        ...
        await query.edit_message_media(
            InputMediaPhoto("https://graph.org/file/7a5d50e580861ad55f80f-62b7e9513b71a8feb8.jpg", 
                            ABOUT_TXT.format(
                                botname = client.name,
                                ownername = ownername, 
                            )
        ...
        await query.message.reply_photo(
            photo=("https://graph.org/file/d4225422a3ac54c01c4f8-2367642f7ae0376f6a.jpg"),
